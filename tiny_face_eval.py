...
def evaluate(weight_file_path, data_dir, output_dir, res_path, resource, prob_thresh=0.5, nms_thresh=0.1, lw=3, display=False):
  ...
  with tf.Session(config=config) as sess:
    ...
    for filename in filenames:
      ...
      res[filename] = refined_bboxes
  with open(res_path, 'wb') as f:
    pickle.dump(res, f)

def call(weight_file_path, data_dir, output_dir, resource, res_path):
  ...
  with tf.Graph().as_default():
    evaluate(
      weight_file_path=weight_file_path, data_dir=data_dir, output_dir=output_dir,
      prob_thresh=args.prob_thresh, res_path=res_path, resource=resource, nms_thresh=args.nms_thresh,
